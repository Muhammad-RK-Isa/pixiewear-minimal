                    ...
                    <div className="hidden min-w-0 gap-1 lg:flex">
                      {selectedValues.size > 2 ? (
                        ...
                        filterField.options
                          ...
                          .map((option) => (
                            <Badge
                              className="truncate rounded-md px-1 font-normal"
                              key={option.value}
                              variant="secondary"
                            >
                              {option.label}
    ...
    <Sortable
      ...
      overlay={
        <div className="flex items-center gap-2">
          <div className="h-8 min-w-[4.5rem] rounded-md bg-primary/10" />
          <div className="h-8 w-32 rounded-md bg-primary/10" />
          <div className="h-8 w-32 rounded-md bg-primary/10" />
          <div className="h-8 min-w-36 flex-1 rounded-md bg-primary/10" />
        ...
        >
          ...
          <div className="flex max-h-40 flex-col gap-2 overflow-y-auto py-0.5 pr-1">
            {filters.map((filter, index) => {
              ...
              return (
                <SortableItem asChild key={filter.rowId} value={filter.rowId}>
                  <div className="flex items-center gap-2">
